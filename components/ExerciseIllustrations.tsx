  ...
  if (category === 'core') {
    return (
      <div className="relative">
        ...
        <span className="absolute -bottom-1 right-2 text-[10px] font-bold tracking-wider" style={{ color: NEON.xp, fontFamily: "'Space Grotesk', sans-serif" }}>HOLD</span>
      </div>
    );
  }
  if (category === 'mobility') {
    return (
      <div className="relative">
        ...
        <span className="absolute bottom-0 right-4 text-[10px] font-bold tracking-wider" style={{ color: NEON.mobility, fontFamily: "'Space Grotesk', sans-serif" }}>HOLD & BREATHE</span>
      </div>
    );
  }
  if (category === 'carry') {
